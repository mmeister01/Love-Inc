...
<!--<![endif]-->
	<head>
		...
		<meta name="author" content="Alex Johnson, David Poling, and Melanie Meister">
					...
					<div class="col-md-4">
						...
						<div class="header-left clearfix">
							...
							<div class="site-name-and-slogan smooth-scroll">
								<div class="site-name"><a href="#banner">Love INC</a></div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<ul class="list-unstyled">
									<li><i class="fa fa-caret-right pr-10 text-colored"></i> </li>
								</ul>
							</div>
						</div>
						<div class="space"></div>
					...
					<div class="col-md-12">
						...
						<div class="filters text-center">
							<ul class="nav nav-pills">
								...
								<li><a href="#" data-filter=".web-design"></a></li>
								<li><a href="#" data-filter=".app-development"></a></li>
								<li><a href="#" data-filter=".site-building"></a></li>
							</ul>
						</div>
						<!-- isotope filters end -->
